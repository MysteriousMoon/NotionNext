...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ByteSage', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个爱折腾的同学', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.techleaf.xyz', // 网站地址
